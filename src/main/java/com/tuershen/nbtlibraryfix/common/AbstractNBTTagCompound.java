package com.tuershen.nbtlibraryfix.common;
...
import com.tuershen.nbtlibraryfix.data.LibraryInventory;
import com.tuershen.nbtlibraryfix.data.LibraryItem;
import com.tuershen.nbtlibraryfix.util.LibraryUtil;
...
import com.tuershen.nbtlibraryfix.common.difference.*;
import com.tuershen.nbtlibraryfix.io.SerializableStream;
import com.tuershen.nbtlibraryfix.minecraft.nbt.*;
...
import static com.tuershen.nbtlibraryfix.CompoundLibraryManager.server;
...
public abstract class AbstractNBTTagCompound implements
    ...
    public String toString() {
        return new StringJoiner(", ", AbstractNBTTagCompound.class.getSimpleName() + "[", "]")
    ...
    public static AbstractMinecraftNBTTag getMinecraftNBTTag() {
        return minecraftNBTTag;
    }

    public static Map<String, Class<? extends TagBase>> getTagFactory() {
        return tagFactory;
    }

    public static Map<String, Class<?>> getNmsFactory() {
        return nmsFactory;
    }

    public static DifferenceCompoundEnum getDifferenceCompoundEnum() {
    ...
    public Inventory deserializeInventory(String data) {
        ...
        Inventory inventory = server.createInventory(null, libraryInventory.getSize(), libraryInventory.getTitle());
